...
const BOOK_COUNT = 3; // Always generate 3 books per call
...
5. **ISBN-13は必ず記載する**：実在する書籍のISBN-13コードを正確に記載する
  ...
  "books": [
    {
      "title": "正確な書籍タイトル",
      "author": "著者名",
      "isbn": "ISBN-13コード（13桁の数字）。必ず記載する",
      "label": "noteから導かれる一言オリジナルラベル",
      "headline": "なぜおすすめなのかのタイトル",
      "oneliner": "20〜40字のヒトコト推薦",
...
export async function POST(req: Request) {
  try {
    ...
    // Heart profile context for returning users
    let pastContext = '';
...
- isbn: 各書籍のISBN-13コードを必ず記載する${exclusionNote}
